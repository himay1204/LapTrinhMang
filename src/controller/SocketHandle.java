    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                String req = msg[0];
                System.out.println("req la " + req);
                
                // xu ly dang nhap
                if (req.equals("login-request")) {
                    User u = udb.findByName(msg[1]);// msg[1] la name, msg[2] la pass
                    if (u == null) {
                        message = "login-fail";
                ...
                // xu ly dang ky
                if (req.equals("register-request")) { // req = msg[0]
                    String name = msg[1];
                    String pass = msg[2];
                ...
                } else if (req.equals("search-room-request")) {
                ...
                } else if (req.equals("delete-room-request")) {
                    msg = receivedMessage.split(";");
                ...
                else if (req.equals("change-room-request")) {
                    msg = receivedMessage.split(";");
                    String roomName = msg[1];
                    String floorName = msg[2];
                    String name = msg[3];
                ...
                else if (req.equals("get-floor-close-request")) {
                    String res = fdb.getAllUnuseFloors();
                    message = "get-floor-close-success;" + res;
                }
                
                else if (req.equals("add-floor-request")) {
                    System.out.println("da nhan dk tin hieu tu vũ trụ");
                    msg = receivedMessage.split(";");
                ...
                else if (req.equals("add-room-request")) {
                    msg = receivedMessage.split(";");
                    String floorName = msg[1];
                    String name = msg[2];
                    String area = msg[3];
                ...
                else if (req.equals("change-floor-describe-request")) {
                    msg = receivedMessage.split(";");
                    String floorName = msg[1];
